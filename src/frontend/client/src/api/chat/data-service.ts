...
import * as a from '~/types/chat/assistants';
import * as f from '~/types/chat/files';
import * as m from '~/types/chat/mutations';
import * as q from '~/types/chat/queries';
...
}): Promise<f.DeleteFilesResponse> => Promise.resolve({
  message: '',
  result: {}
});
