...
| Bug ID | 来源 | 状态 | 说明 | 证据 |
|---|---|---|---|---|
| F042-02 | 用户手工检查 TC-011 | 修复中 | 管理后台点击【字体大小】后，滑杆在个人主菜单内部向下展开，导致菜单突然变高且一级菜单与字号控件层级混杂；目标为从主菜单左侧弹出独立气泡 | `test-evidence/run-2/TC-011-admin-inline-expanded-full.png`、`TC-011-admin-inline-expanded-detail.png` |
